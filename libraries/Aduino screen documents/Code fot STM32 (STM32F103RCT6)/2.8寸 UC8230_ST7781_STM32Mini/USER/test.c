...
void main_test(void)
{
	...
	Gui_StrCenter(0,90,YELLOW,BLUE,"2.8' UC8230 320X240",16,1);//居中显示
	Gui_StrCenter(0,120,BLUE,BLUE,"xiaoFeng@QDtech 2016-02-25",16,1);//居中显示
	delay_ms(1500);		
	delay_ms(1500);
}
...
void Test_Color(void)
{
	...
	Gui_StrCenter(0,60,RED,BLUE,"测试项目一",16,1);//居中显示	
	Gui_StrCenter(0,80,RED,BLUE,"请检查亮点",16,1);//居中显示

	Show_Str(lcddev.width-50,30,BLUE,YELLOW,"BLACK",16,1);delay_ms(200);delay_ms(500);
	
	LCD_Fill(0,0,lcddev.width,lcddev.height,WHITE);
	Gui_StrCenter(0,60,RED,BLUE,"测试项目一",16,1);//居中显示	
	Gui_StrCenter(0,80,RED,BLUE,"请检查背光",16,1);//居中显示

	Show_Str(lcddev.width-50,30,BLUE,YELLOW,"White",16,1);delay_ms(200);delay_ms(500);

	LCD_Fill(0,0,lcddev.width,lcddev.height,RED);
	Gui_StrCenter(0,60,WHITE,BLUE,"测试项目二",16,1);//居中显示	
	Gui_StrCenter(0,80,WHITE,BLUE,"请检查坏点亮点暗点",16,1);//居中显示	
	Show_Str(lcddev.width-50,30,BLUE,YELLOW,"Red",16,1); delay_ms(800);
	
	LCD_Fill(0,0,lcddev.width,lcddev.height,GREEN);
	Gui_StrCenter(0,60,RED,BLUE,"测试项目二",16,1);//居中显示	
	Gui_StrCenter(0,80,RED,BLUE,"请检查坏点亮点暗点",16,1);//居中显示
	Show_Str(lcddev.width-50,30,BLUE,YELLOW,"Green",16,1);delay_ms(800);
	LCD_Fill(0,0,lcddev.width,lcddev.height,BLUE);
	Gui_StrCenter(0,60,RED,BLUE,"测试项目二",16,1);//居中显示	
	Gui_StrCenter(0,80,RED,BLUE,"请检查坏点亮点暗点",16,1);//居中显示
	Show_Str(lcddev.width-50,30,WHITE,YELLOW,"Blue",16,1);delay_ms(800);
